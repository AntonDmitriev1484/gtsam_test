...
int main(int argc, char* argv[]) {
    ...
    data_filename = "/home/admitriev/Datasets/GTSAM_examples/imuAndGPSdata.csv";
    output_filename = "/home/admitriev/Datasets/GTSAM_examples/imuAndGPSdata_output.csv";

    //var_map["use_isam"] = true;
    ...
    t.est_poses.push_back(prior_pose);
    t.est_velocitys.push_back(prior_velocity);
    ...
    auto pose_noise_model = noiseModel::Diagonal::Sigmas(
        (Eigen::Vector<double, 6>() << 0.5, 0.5, 0.5, 0.01, 0.01, 0.01).finished()
...
// All priors have been set up, now iterate through the data file.
    while (file.good()) {
        ...
        if (type == 0) {  // IMU measurement
            ...
            t.gt_poses.push_back(Pose3(Rot3::Identity(), Point3(gps(0),   // N,
                gps(1),   // E,
                gps(2))));
    ...
    hold(on);
    draw_trajectory(t.est_poses, "blue");
    hold(on);
    draw_trajectory(t.gt_poses, "green");
    hold(on);
