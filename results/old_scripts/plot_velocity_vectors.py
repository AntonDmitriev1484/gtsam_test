...
def main():
    suwb_poses = read_htms("./stereoi_circle2/synthetic_1_5_uwb/gt_base_poses.txt")
    mag_vectors = read_htms("./stereoi_circle2/synthetic_1_5_uwb/vel_vectors.txt")

    if len(suwb_poses) != len(mag_vectors):
        print(f"{len(suwb_poses)=} {len(mag_vectors)=}")
